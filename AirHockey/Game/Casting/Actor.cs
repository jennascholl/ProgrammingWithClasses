...
namespace Unit04.Game.Casting
{
    ...
    public class Actor
    {
        ...
        /// <summary>
        /// Determines whether the actor has text
        /// </summary>
        /// <returns>Boolean representing whether or not the actor has text.</returns>
        public bool HasText()
        {
            return text != "";
        }
        /// <summary>
        /// Determines whether the actor is rectangular
        /// </summary>
        /// <returns>Boolean representing whether or not the actor is rectangular.</returns>
        public bool HasBox()
        {
            return width > 0 && height > 0;
        }
        /// <summary>
        /// Determines whether the actor is circular
        /// </summary>
        /// <returns>Boolean representing whether or not the actor is circular.</returns>
